...
export default class Login extends Taro.Component {
  ...
  render() {
    return <View className="login-page">
        ...
        <AtInput name="value" title="手机号" type="text" placeholder="请输入手机号" value={this.state.telephone} onChange={this.handleChange.bind(this)} />
        <AtInput name="value" title="密码" type="password" placeholder="请输入密码" value={this.state.password} onChange={this.handleChange.bind(this)} />
